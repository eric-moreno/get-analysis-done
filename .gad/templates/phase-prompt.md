...
> **Note:** Planning methodology is in `agents/gad-lead-analyst.md`.
...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-analysis-done/references/checkpoints.md -->
...
See `~/.claude/get-analysis-done/references/tdd.md` for TDD plan structure.
...
See `~/.claude/get-analysis-done/templates/user-setup.md` for full schema and examples
...
See `~/.claude/get-analysis-done/workflows/verify-phase.md` for verification logic.
