...
Template for spawning gad-detector-specialist agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="gad-detector-specialist", description="Debug UAT-001")
```
