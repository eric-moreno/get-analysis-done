...
│   └── gad/           # GAD-specific commands
├── get-analysis-done/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/gad/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-analysis-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-analysis-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-analysis-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-analysis-done/references/{name}.md`
