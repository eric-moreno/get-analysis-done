...
```bash
node "$HOME/.claude/get-analysis-done/bin/gad-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
