...
<execution_context>
@~/.claude/get-analysis-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @~/.claude/get-analysis-done/workflows/execute-phase.md end-to-end.
