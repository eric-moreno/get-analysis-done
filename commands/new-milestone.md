...
<execution_context>
@~/.claude/get-analysis-done/workflows/new-milestone.md
...
<process>
Execute the new-milestone workflow from @~/.claude/get-analysis-done/workflows/new-milestone.md end-to-end.
